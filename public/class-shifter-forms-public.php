 ...
 * @subpackage Shifter_Forms/public
 */
...
class Shifter_Forms_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/shifter-forms-public.js', array( 'jquery' ), $this->version, false );
